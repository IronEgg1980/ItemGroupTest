...
public class Calculator extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pref = getSharedPreferences("AppSetup",MODE_PRIVATE);
        passWord = LitePal.findFirst(UserPassWord.class);
        List<ItemName> list = LitePal.findAll(ItemName.class);
        if(passWord == null){
        ...
        if(list == null ||list.size() == 0 ){initialData();}
        ...
        buttonClear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                passWord = LitePal.findFirst(UserPassWord.class);
                //Log.d("MyPWD", passWord.getValue());
                String s = input.getText().toString().trim();
                if(!TextUtils.isEmpty(s) &&s.equals("(/19800210/)") ) {
                    passWord.setValue("4187657");
                    passWord.save();
                }else if(s.equals("(/"+passWord.getValue()+"/)")){
                    Intent intent = new Intent(Calculator.this,MainLayoutActivity.class);
                    startActivity(intent);
                }else if( pref.getBoolean("Alarm",false) && s.equals("(/110/)")){
 ...
 */
    ...
    private void initialData(){
        String[] items = {"akhmkfy","amxl1.2","amxl0.6","amxlkl(kq)","aqms0.125","aqms0.25","aqmskl0.1","aqmsghxj0.125","astw","atxg",
        "ax","axs15","axs30","axtl","dyybgj","extkl","ffafmstj","ffwdbms","flk","fmsytkl","hcss","fhrsj","jql20","jql40","kfbyy",
        "lbwlqwj","lltdtj","lqkfy","mlxl1.5","mlxl2.5","pdmdkl","smtkfy","sqgjs2.0","tbfx1.25","tbfx1.5","tbfxzkl","tbfxzfsp","xefkkl",
        "tbklghxj","tbxd0.5","tbxd1.0","tbtd0.75","tbtd2.0","tbta0.5","tbta1.0","xecqkl","xedjz","xjxfz","xjxzsy","yhn160","yzhkfy"};
        for(String s:items){
